        ...
        return $form->schema([
            Forms\Components\Section::make('البيانات الأساسية')->schema([
                Forms\Components\TextInput::make('internal_code')
                    ->label('الكود الداخلي (للإدارة فقط)')
                    ->maxLength(60)
                    ->unique(ignoreRecord: true)
                    ->helperText('كود تعريفي خاص بك — لا يظهر للعملاء إطلاقًا، يُستخدم للبحث والجرد السريع'),
            ...
            Forms\Components\Section::make('الأسعار (الدولار أساس التسعير)')->schema([
                ...
                Forms\Components\Toggle::make('hide_wholesale')
                    ->label('إخفاء سعر الجملة لهذا المنتج')
                    ->helperText('يخفي سعر الجملة عن العملاء ويعرضهم على السعر العادي — مستقل عن الإعدادات العامة')
                    ->columnSpan(2),
