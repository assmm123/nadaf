...
<body class="flex min-h-screen flex-col bg-ivory text-[#1B242E] antialiased">
    ...
    <div x-data="{ online: navigator.onLine }"
         ...
         class="fixed inset-x-0 top-0 z-[100] bg-[#8E2C33] py-2.5 text-center text-sm font-extrabold text-white shadow-lg">
        ⚠️ لا يوجد اتصال بالإنترنت — تحقق من اتصالك ثم أعد تحميل الصفحة
    </div>
